<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test(Sem2).aspx.cs" Inherits="Test_Sem2_" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="APH" HeaderText="APH" SortExpression="APH" />
                <asp:BoundField DataField="ACH" HeaderText="ACH" SortExpression="ACH" />
                <asp:BoundField DataField="PIC" HeaderText="PIC" SortExpression="PIC" />
                <asp:BoundField DataField="BEL" HeaderText="BEL" SortExpression="BEL" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Result_AnalysisConnectionString11 %>" 
            SelectCommand="SELECT * FROM [Semester2_MT]"></asp:SqlDataSource>
