<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test(Sem4).aspx.cs" Inherits="Test_Sem4_" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CHM" HeaderText="CHM" SortExpression="CHM" />
                ...
                <asp:BoundField DataField="OOP" HeaderText="OOP" SortExpression="OOP" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Result_AnalysisConnectionString13 %>" 
            SelectCommand="SELECT * FROM [Semester4_MT]"></asp:SqlDataSource>
