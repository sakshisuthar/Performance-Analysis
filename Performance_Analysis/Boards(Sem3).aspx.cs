...
public partial class Boards_Sem3_ : System.Web.UI.Page
{
    ...
    public void ReplaceDiv()
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Enroll_No,Surname,Firstname,Middlename,Seatnumber,Ams_TH,Dsu_TH,Dsu_PR,Dsu_TW,Ete_TH,Ete_TW,Rdm_TH,Rdm_OR,Rdm_TW,Dte_TH,Dte_TW,Gui_PR,Ppo_TW ,SW,Total,Percentage,Remarks from Semester3 where Enroll_No='" + stud_enroll + "' ";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
