...
public partial class Semester6_read_ : System.Web.UI.Page
{
    ...
    private void Auto_Gen()
    {
        ...
        cn.Open();
        cmd1.Connection = cn;
        cmd1.CommandText = "select count(*) from Semester6";
        ...
        if (cnt > 0)
        {
            cn.Open();
            cmd1.Connection = cn;
            cmd1.CommandText = "select max(ID) from Semester6";
            rs = cmd1.ExecuteReader();
            while (rs.Read())
            {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i < list1.Count; i++)//for entering into the excel sheet
        {
            ...
            cmd1.Connection = cn;
            cmd1.CommandText = "select count(*) from Semester6 where Enroll_No='" + list1[i].ToString() + "'";
            rs = cmd1.ExecuteReader();
            while (rs.Read())
            {
            ...
            if (count1 == 0)
            {
                ...
                qry = "insert into Semester6 (ID,Enroll_No,Surname,Firstname,Middlename,Seatnumber,Man_TH,Mco_TH ,Mco_PR,Mco_TW ,Ajp_TH ,Ajp_PR,Ajp_TW ,Oom_TH,Oom_TW,Ste_PR,Ste_TW,Ipr_OR,Ipr_TW,Ede_TW ,Sw ,Total,Percentage,Remarks)values('" + auto + "','" + list1[i].ToString() + "','" + list2[i].ToString() + "','" + list3[i].ToString() + "','" + list4[i].ToString() + "','" + list5[i].ToString() + "','" + list6[i].ToString() + "','" + list7[i].ToString() + "','" + list8[i].ToString() + "','" + list9[i].ToString() + "','" + list10[i].ToString() + "','" + list11[i].ToString() + "','" + list12[i].ToString() + "','" + list13[i].ToString() + "','" + list14[i].ToString() + "','" + list15[i].ToString() + "','" + list16[i].ToString() + "','" + list17[i].ToString() + "','" + list18[i].ToString() + "','" + list19[i].ToString() + "','" + list20[i].ToString() + "','" + list21[i].ToString() + "','" + list22[i].ToString() + "','" + list23[i].ToString() + "')";

            }
            else
            {//for updating database
                qry = "update  Semester6 set Surname='" + list2[i].ToString() + "',Firstname='" + list3[i].ToString() + "',Middlename='" + list4[i].ToString() + "',Seatnumber='" + list5[i].ToString() + "',Man_TH ='" + list6[i].ToString() + "',Mco_TH='" + list7[i].ToString() + "',Mco_PR ='" + list8[i].ToString() + "',Mco_TW ='" + list9[i].ToString() + "',Ajp_TH='" + list10[i].ToString() + "',Ajp_PR='" + list11[i].ToString() + "',Ajp_TW ='" + list12[i].ToString() + "',Oom_TH ='" + list13[i].ToString() + "',Oom_TW='" + list14[i].ToString() + "',Ste_PR ='" + list15[i].ToString() + "',Ste_TW ='" + list16[i].ToString() + "',Ipr_OR='" + list17[i].ToString() + "',Ipr_TW='" + list18[i].ToString() + "',Ede_TW ='" + list19[i].ToString() + "',Sw ='" + list20[i].ToString() + "',Total='" + list21[i].ToString() + "',Percentage='" + list22[i].ToString() + "',Remarks='" + list23[i].ToString() + "' where Enroll_No='" + list1[i].ToString() + "' ";
            }
