...
public partial class Boards_Sem2_ : System.Web.UI.Page
{
    ...
    public void ReplaceDiv() 
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Enroll_No,Surname,Firstname,Middlename,Seatnumber, Cms_TH,Cms_OR,Cms_TW, Aps_TH, Aps_TW,Pic_TH,Pic_PR,Pic_TW,Bel_TH,Bel_TW ,EMS_TH,Dls_OR,Wpd_PR, SW,Total,Percentage,Remarks from Semester2 where Enroll_No='" + stud_enroll + "' ";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
