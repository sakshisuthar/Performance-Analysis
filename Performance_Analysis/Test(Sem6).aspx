<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test(Sem6).aspx.cs" Inherits="Test_Sem6_" %>
<!DOCTYPE html>
...
<div class="col-md-3">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Result_AnalysisConnectionString15 %>" 
