...
public partial class Semester4_read_ : System.Web.UI.Page
{
    ...
    private void Auto_Gen()
    {
        ...
        cn.Open();
        cmd1.Connection = cn;
        cmd1.CommandText = "select count(*) from Semester4";
        ...
        if (cnt > 0)
        {
            cn.Open();
            cmd1.Connection = cn;
            cmd1.CommandText = "select max(ID) from Semester4";
            rs = cmd1.ExecuteReader();
            while (rs.Read())
            {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "select * FROM [IF4G$]";//for fetching data from excel sheet(sheet1)
        ...
        OleDbDataReader rs1;
        cmd.Connection = conn;
        cmd.CommandText = "select * from [IF4G$]";
        ...
        while (rs1.Read())
        {
            if (rs1.GetValue(0).ToString() != "")
            {
                ...
                list26.Add(rs1.GetValue(25).ToString());
        ...
        for (i = 0; i < list1.Count; i++)//for entering into the excel sheet
        {
            ...
            cmd1.Connection = cn;
            cmd1.CommandText = "select count(*) from Semester4 where Enroll_No='" + list1[i].ToString() + "'";
            rs = cmd1.ExecuteReader();
            while (rs.Read())
            {
            ...
            if (count1 == 0)
            {
                ...
                qry = "insert into Semester4 (ID,Enroll_No,Surname,Firstname,Middlename,Seatnumber,Est_TH ,Est_TW  ,Chm_TH,Chm_PR ,Chm_TW ,Dcn_TH ,Dcn_PR ,Dcn_TW,Map_TH,Map_PR ,Map_TW,Oop_TH,Oop_PR,Oop_TW,Amt_PR,Amt_TW,Ppt,Sw ,Total,Percentage,Remarks)values('" + auto + "','" + list1[i].ToString() + "','" + list2[i].ToString() + "','" + list3[i].ToString() + "','" + list4[i].ToString() + "','" + list5[i].ToString() + "','" + list6[i].ToString() + "','" + list7[i].ToString() + "','" + list8[i].ToString() + "','" + list9[i].ToString() + "','" + list10[i].ToString() + "','" + list11[i].ToString() + "','" + list12[i].ToString() + "','" + list13[i].ToString() + "','" + list14[i].ToString() + "','" + list15[i].ToString() + "','" + list16[i].ToString() + "','" + list17[i].ToString() + "','" + list18[i].ToString() + "','" + list19[i].ToString() + "','" + list20[i].ToString() + "','" + list21[i].ToString() + "','" + list22[i].ToString() + "','" + list23[i].ToString() + "','" + list24[i].ToString() + "','" + list25[i].ToString() + "','" + list26[i].ToString() + "')";

            }
            else
            {//for updating database
                qry = "update  Semester4 set Surname='" + list2[i].ToString() + "',Firstname='" + list3[i].ToString() + "',Middlename='" + list4[i].ToString() + "',Seatnumber='" + list5[i].ToString() + "',Est_TH ='" + list6[i].ToString() + "',Est_TW='" + list7[i].ToString() + "',Chm_TH ='" + list8[i].ToString() + "',Chm_PR ='" + list9[i].ToString() + "',Chm_TW='" + list10[i].ToString() + "',Dcn_TH ='" + list11[i].ToString() + "',Dcn_PR='" + list12[i].ToString() + "',Dcn_TW='" + list13[i].ToString() + "',Map_TH='" + list14[i].ToString() + "',Map_PR ='" + list15[i].ToString() + "',Map_TW ='" + list16[i].ToString() + "',Oop_TH='" + list17[i].ToString() + "',Oop_PR='" + list18[i].ToString() + "',Oop_TW ='" + list19[i].ToString() + "',Amt_PR='" + list20[i].ToString() + "',Amt_TW='" + list21[i].ToString() + "',Ppt='" + list22[i].ToString() + "',Sw='" + list23[i].ToString() + "',Total='" + list24[i].ToString() + "',Percentage='" + list25[i].ToString() + "',Remarks='" + list26[i].ToString() + "' where Enroll_No='" + list1[i].ToString() + "' ";
            }
