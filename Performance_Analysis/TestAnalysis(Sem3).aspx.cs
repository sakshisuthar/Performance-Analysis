...
public partial class TestAnalysis_Sem3_ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Total from Semester3_MT";
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select count(*) from Semester3_MT";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select count(*) from Semester3_MT where Percentage>='35'";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select count(*) from Semester3_MT where Percentage>'60'";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Total,Firstname,Middlename,Surname from Semester3_MT order by Percentage desc";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Total,Firstname,Middlename,Surname from Semester3_MT order by Percentage asc";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
