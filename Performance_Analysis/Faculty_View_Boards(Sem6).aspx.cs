...
public partial class Faculty_View_Boards_Sem6_ : System.Web.UI.Page
{
    ...
    public void ReplaceDiv()
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Total From Semester5 where Enroll_No='" + Textbox1.Text + "' ";
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select count(*) from Semester6 where Enroll_No='" + Textbox1.Text + "'";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Enroll_No,Surname,Firstname,Middlename,Seatnumber,Man_TH,Mco_TH,Mco_PR,Mco_TW,Ajp_TH,Ajp_PR,Ajp_TW,Oom_TH,Oom_TW,Ste_PR,Ste_TW,Ipr_OR,Ipr_TW,Ede_TW,SW,Total,Percentage,Remarks from Semester6 where Enroll_No='" + Textbox1.Text + "' ";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
