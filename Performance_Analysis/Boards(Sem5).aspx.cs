...
public partial class Boards_Sem5_ : System.Web.UI.Page
{
    ...
    public void ReplaceDiv()
    {
      string stud_enroll = "";
        ...
        string Remarks = "";
          ...
          cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Enroll_No,Surname,Firstname,Middlename,Seatnumber,Osy_TH,Osy_TW,Sen_TH,Ise_TH,Ise_TW,Jpr_TH,Jpr_PR,Jpr_TW,Cte_TH,Cte_PR,Cte_TW,Bsc_OR,Bsc_TW,Nma_PR,Nma_TW,Ppt_TW,SW,Total,Percentage,Remarks from Semester5 where Enroll_No='" + stud_enroll + "' ";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
