...
public partial class Faculty_Login : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select count(*) from Faculty_Login where Username='" + Textbox1.Text + "' and Password='" + Textbox2.Text + "'";
        ...
        if (login > 0)
        {
            Session["faculty_Username"] = Textbox1.Text;
            Response.Redirect("Homepage(Faculty).aspx");
        }
        else
        {
