<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test(Sem5).aspx.cs" Inherits="Test_Sem5_" %>
<!DOCTYPE html>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="OSY" HeaderText="OSY" SortExpression="OSY" />
                <asp:BoundField DataField="SEN" HeaderText="SEN" SortExpression="SEN" />
                <asp:BoundField DataField="ISE" HeaderText="ISE" SortExpression="ISE" />
                <asp:BoundField DataField="JPR" HeaderText="JPR" SortExpression="JPR" />
                <asp:BoundField DataField="CTE" HeaderText="CTE" SortExpression="CTE" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Result_AnalysisConnectionString14 %>" 
            SelectCommand="SELECT * FROM [Semester5_MT]"></asp:SqlDataSource>
