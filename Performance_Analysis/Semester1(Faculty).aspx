<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Semester1(Faculty).aspx.cs" Inherits="Semester1_Faculty_" %>
...
<div class="col-md-3">
   ...
   <tr>
    ...
    <td><asp:TextBox ID="Textbox6" runat="server"/></td>
     ...
     <tr>
     <td>TH</td>
     <td><asp:Textbox ID="Textbox7" runat="server" Enabled="False"/></td>
     </tr>
      <tr>
     <td>TW</td>
     <td><asp:Textbox ID="Textbox8" runat="server" Enabled="False"/></td>
     </tr>
      <tr>
     <td>PR</td>
     <td><asp:Textbox ID="Textbox9" runat="server" Enabled="False"/></td>
     </tr>
      <tr>
     <td>SW</td>
     <td><asp:Textbox ID="Textbox10" runat="server" Enabled="False"/></td>
     </tr>
     </table>
