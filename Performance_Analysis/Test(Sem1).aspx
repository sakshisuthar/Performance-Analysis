<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test(Sem1).aspx.cs" Inherits="Test_Sem1_" %>
...
<div class="col-md-3">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Result_AnalysisConnectionString10 %>" 
