...
public partial class Semester2_read_ : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "select * FROM [IF2G$]";//for fetching data from excel sheet(sheet1)
        ...
        for (i = 0; i < list1.Count; i++)//for entering into the excel sheet
        {
            ...
            cmd1.Connection = cn;
            cmd1.CommandText = "select count(*) from Semester2 where Enroll_No='" + list1[i].ToString() + "'";
            rs = cmd1.ExecuteReader();
            while (rs.Read())
            {
            ...
            if (count1 == 0)
            {
                ...
                qry = "insert into Semester2 (ID,Enroll_No,Surname,Firstname,Middlename,Seatnumber,Cms_TH ,Cms_OR ,Cms_TW,Aps_TH ,Aps_TW,Pic_TH,Pic_PR ,Pic_TW,Bel_TH,Bel_TW,Ems_TH,Dls_OR,Wpd_PR,Sw  ,Total,Percentage,Remarks)values('" + auto + "','" + list1[i].ToString() + "','" + list2[i].ToString() + "','" + list3[i].ToString() + "','" + list4[i].ToString() + "','" + list5[i].ToString() + "','" + list6[i].ToString() + "','" + list7[i].ToString() + "','" + list8[i].ToString() + "','" + list9[i].ToString() + "','" + list10[i].ToString() + "','" + list11[i].ToString() + "','" + list12[i].ToString() + "','" + list13[i].ToString() + "','" + list14[i].ToString() + "','" + list15[i].ToString() + "','" + list16[i].ToString() + "','" + list17[i].ToString() + "','" + list18[i].ToString() + "','" + list19[i].ToString() + "','" + list20[i].ToString() + "','" + list21[i].ToString() + "','" + list22[i].ToString() + "')";

            }
            else
            {//for updating database
                qry = "update  Semester2 set Surname='" + list2[i].ToString() + "',Firstname='" + list3[i].ToString() + "',Middlename='" + list4[i].ToString() + "',Seatnumber='" + list5[i].ToString() + "',Cms_TH='" + list6[i].ToString() + "',Cms_OR='" + list7[i].ToString() + "',Cms_TW='" + list8[i].ToString() + "',Aps_TH='" + list9[i].ToString() + "',Aps_TW='" + list10[i].ToString() + "',Pic_TH='" + list11[i].ToString() + "',Pic_PR='" + list12[i].ToString() + "',Pic_TW='" + list13[i].ToString() + "',Bel_TH='" + list14[i].ToString() + "',Bel_TW='" + list15[i].ToString() + "',Ems_TH='" + list16[i].ToString() + "',Dls_OR='" + list17[i].ToString() + "',Wpd_PR='" + list18[i].ToString() + "',Sw ='" + list19[i].ToString() + "',Total='" + list20[i].ToString() + "',Percentage='" + list21[i].ToString() + "',Remarks='" + list22[i].ToString() + "' where Enroll_No='" + list1[i].ToString() + "' ";
            }
