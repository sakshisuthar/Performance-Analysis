<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Seat_Number_Assignment.aspx.cs" Inherits="Seat_Number_Assignment" %>
...
<div class="col-md-3">
    ...
    <div>
    <h1><center>Seat Number Assignment</h1></center>
    <table>
    <tr>
    <td>Ass ID</td>
   ...
   <td>Student ID</td>
    ...
    <asp:ListItem Text="Please Select One.." Value="Please Select One.."/>
    </asp:DropdownList></td>
    </tr>
    <tr>
    <td>Seat Number</td>
