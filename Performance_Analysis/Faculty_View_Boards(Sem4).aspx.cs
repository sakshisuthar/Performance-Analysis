...
public partial class Faculty_View_Boards_Sem4_ : System.Web.UI.Page
{
    ...
    public void ReplaceDiv()
    {
        ...
        //cn.Open();
        //cmd1.Connection = cn;
        //cmd1.CommandText = "select Stud_Enrol from Student where Stud_Email='" + Session["Student_Username"] + "'";
        ...
        cn.Open();
        cmd1.Connection = cn;
        cmd1.CommandText = "Select count(*) from Semester4 where Enroll_No='" + Textbox1.Text + "'";
        rs = cmd1.ExecuteReader();
        while (rs.Read())
        {
        ...
        cn.Open();
        cmd1.Connection = cn;
        cmd1.CommandText = "select Enroll_No,Surname,Firstname,Middlename,Seatnumber,Est_TH,Est_TW,Chm_TH,Chm_PR,Chm_TW,Dcn_TH,Dcn_PR,Dcn_TW,Map_TH,Map_PR,Map_TW,Oop_TH,Oop_PR,Oop_TW,Amt_PR,Amt_TW,Ppt,SW,Total,Percentage,Remarks from Semester4 where Enroll_No='" + Textbox1.Text + "' ";
        rs = cmd1.ExecuteReader();
        while (rs.Read())
        {
