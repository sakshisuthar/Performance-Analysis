<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subject_Mapping(Faculty).aspx.cs" Inherits="Subject_Mapping_Faculty_" %>
<!DOCTYPE html>
...
<div class="col-md-3">
   ...
   <tr>
   <td>ID</td>
   <td><asp:Textbox ID="Textbox1" runat="server" ontextchanged="Textbox1_TextChanged"/></td>
   </tr>
    <tr>
   <td>Faculty ID</td>
  ...
  <tr>
     <td>Sem</td>
    <td><asp:DropdownList ID="DropdownList3" runat="server" AutoPostBack="True" 
