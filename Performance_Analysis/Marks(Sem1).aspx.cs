...
public partial class Marks_Sem1_ : System.Web.UI.Page
{
    ...
    public void ReplaceDiv()
    {
        ...
        cn.Open();
        cmd.Connection = cn;
        cmd.CommandText = "select Enroll_No,Surname,Firstname,Middlename,Seatnumber, Eng_TH, Eng_TW,Bsi_TH ,Bsi_PR,Bms_TH,Egg_PR,Egg_TW,Cmf_PR,Cmf_TW,Wcc_TW,SW,Total,Percentage,Remarks from Semester1 where Enroll_No='" + stud_enroll + "' ";
        rs = cmd.ExecuteReader();
        while (rs.Read())
        {
